...
import { HttpMethods, ContentTypes } from '../../constants/Http.constants';
import {
  IRestClient,
  ParseOption,
  RequestParams,
  ResponseAPI,
  RestClientParams,
} from '../../types/RestClient.types';

const injectPathParameters = (url: string, pathParameters: Record<string, string> = {}) =>
